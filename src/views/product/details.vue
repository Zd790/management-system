<template>
    <div>
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item :to="item.path" v-for="(item,index) in breadlist" :key="index">{{item}}</el-breadcrumb-item>
        </el-breadcrumb>
        <el-card class="card">
            <el-row>
                <el-col :span="18" class="info" style="text-align:left">
                    <span>申请编号:</span>YGC20170110000001
                    <span>推送时间:</span>2020-05-20
                    <span>推送员:</span>张三丰
                    <span>状态:</span>待上线
                </el-col>
